...
PlantPedia is a web application that allows users to discover, explore, and save their favorite plants.
It integrates with the Trefle API
 to fetch detailed information about a wide variety of plant species.
...
Users can scroll through the list to explore different species and <ins> **click any item for more details.**</ins>
...
- 🌿 A larger image of the plant

- 🧬 Scientific classification

- 📖 Description information

- ❤️ A “Favorite” button that allows users to save the plant to their favorites list
...
🌸 View all saved plants in one place
